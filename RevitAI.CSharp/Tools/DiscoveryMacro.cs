 ...
 * REVIT MACRO VERSION
 *
 * This is a simplified version formatted for easy copy-paste into Revit's Macro Manager.
 *
 * HOW TO USE:
 * 1. Open Revit 2026
 * 2. Open temp/test_rooms.rvt
 * 3. Go to Manage tab → Macro Manager
 * 4. Click "Module" → "Create" (choose "Application" or "Document" level)
 * 5. Name it "DiscoveryModule"
 * 6. In the SharpDevelop IDE that opens:
 *    - Replace the entire content with the code below
 *    - Build (F8) and Run (F5)
 * 7. The macro will analyze the document and save a report
 *
 * OUTPUT:
